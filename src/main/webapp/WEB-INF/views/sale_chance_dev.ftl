<html>
    <head>
        ...
        <script type="text/javascript" src="${ctx}/static/js/sale.chance.dev.js"></script>
    </head>
    <body >
    <#--营销机会详情展示-->
        <div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 350px;padding: 10px">
         <table cellspacing="8px">
            ...
            <tr>
                <td>联系人：</td>
                <td><input type="text" id="linkMan" name="linkMan" readonly="readonly" 
                           value="${(saleChance.linkMan)!""}"/></td>
                <td>    </td>
                <td>联系电话：</td>
                <td>
                    <input type="text" id="linkPhone" name="linkPhone" readonly="readonly" 
                       value="${(saleChance.linkPhone)!""}"/></td>
            </tr>
            <tr>
                <td>成功几率(%)：</td>
                <td><input type="text" id="cgjl" name="cgjl" readonly="readonly" 
                           value="${(saleChance.cgjl)!""}"/></td>
                <td colspan="3">    </td>
            </tr>
            <tr>
                <td>概要：</td>
            ...
            <tr>
                <td>创建人：</td>
                <td>
                    <input type="text" readonly="readonly" id="createMan" name="createMan" 
                           value="${(saleChance.createMan)!""}" /></td>
                <td>    </td>
                <td>创建时间：</td>
                <td><input type="text" id="createDate" name="createDate" readonly="readonly"
